...
public abstract class AbstractActivity<T extends Model>
    ...
    public ViewBinder createViewBinder(Bundle savedInstanceState) {
        ...
        try {
            ...
            viewBinder = new Initializer<ViewBinder>().execute(reader.execute(this).initial());
     ...
     */
    public void onUpdateWithSameCategoryId(Event event) {
    ...
    private void invokeOnBackPressed() {
        ...
        try {
            ...
            super.onBackPressed();
        } catch (OnBackPressException exception) {
    ...
    /**
     * exchange the initial model with a new {@link com.base.presentation.models.Model}, notice that this method will
    ...
    /**
     * check if the initial {@link AbstractActivity} is locked or not
     *
