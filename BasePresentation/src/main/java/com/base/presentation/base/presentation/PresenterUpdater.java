 ...
 * {@link #onUpdateViewModel()} is called, and it also updates the {@link Model} from
 * {@link ViewModel} when {@link #onUpdateModel()} is invoked
 * <p>
 * for sub-classes, they can {@code Override} {@link #onUpdateModel()} and
 * {@link #onUpdateViewModel()} to manage updating data on both sides
 * <p>
...
public class PresenterUpdater<
    ...
    public void onUpdateModel() {
        syncTransactionsGroup.onUpdateModel();
    }

    @Override
    @Deprecated
    public void onUpdateViewModel() {
        syncTransactionsGroup.onUpdateViewModel();
    }
