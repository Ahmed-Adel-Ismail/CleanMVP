...
public interface Feature<T extends Model> extends
    ...
    /**
     * get the root view of the initial {@link Feature} implementer (Activity or fragment)
     *
    ...
    /**
     * add a {@link Fragment} to the initial {@link Feature}
     *
     ...
     * notice that before starting the new Activity or service (or finishing the initial one),
