...
public class ActivityResult extends CodedResult {
   ...
   *
   * @param resultCodeIntResource the {@link com.base.presentation.R.integer} resource
   *                              that contains the result code value
   * @return {@code true} if the value of the {@code integer} resource value is the same as the
   * {@link #requestCode}
   * @see com.base.presentation.R.integer#resultCodeOk
   * @see com.base.presentation.R.integer#resultCodeCanceled
   * @see com.base.presentation.R.integer#resultCodeFirstUser
   */
