...
public class PackageInProcessInPickupVerification extends ViewHolderFactory {

    private PackageViewHolder packageViewHolder;


    public PackageInProcessInPickupVerification(PackageViewHolder viewHolder) {
    ...
    public void onDrawITemLayout() {
        ...
        packageViewHolder.image.setImageResource(R.drawable.verification);
    }
}
