...
public class PackageCancelled  extends ViewHolderFactory{

    private PackageViewHolder packageViewHolder;


    public PackageCancelled(PackageViewHolder viewHolder) {
    ...
    public void onDrawITemLayout() {
        ...
        packageViewHolder.image.setImageResource(R.drawable.cancelled);
    }
}
