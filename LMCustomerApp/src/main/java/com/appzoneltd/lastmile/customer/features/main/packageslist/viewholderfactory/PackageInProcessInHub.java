...
public class PackageInProcessInHub extends ViewHolderFactory {

    private PackageViewHolder packageViewHolder;


    public PackageInProcessInHub(PackageViewHolder viewHolder) {
    ...
    public void onDrawITemLayout() {
        ...
        packageViewHolder.image.setImageResource(R.drawable.in_hub_in_transit);
    }
}
