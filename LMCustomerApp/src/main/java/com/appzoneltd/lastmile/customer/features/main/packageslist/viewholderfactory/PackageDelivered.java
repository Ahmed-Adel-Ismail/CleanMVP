...
public class PackageDelivered extends ViewHolderFactory {

    private PackageViewHolder packageViewHolder;


    public PackageDelivered(PackageViewHolder viewHolder) {
    ...
    public void onDrawITemLayout() {
        ...
        packageViewHolder.image.setImageResource(R.drawable.delivered);
    }
}
