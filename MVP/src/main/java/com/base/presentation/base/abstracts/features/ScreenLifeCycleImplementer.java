...
class ScreenLifeCycleImplementer implements ScreenLifeCycle {
    ...
    public void onSaveInstanceState(Bundle bundle) {
        viewBinder.onUpdate(new EventBuilder(R.id.onSaveInstanceState, bundle).execute(feature));
    }

    @Override
    public void onStart() {
        viewBinder.onUpdate(new EventBuilder(R.id.onStart).execute(feature));
    }
    ...
    @Override
    public void onStop() {
        viewBinder.onUpdate(new EventBuilder(R.id.onStop).execute(feature));
    }
