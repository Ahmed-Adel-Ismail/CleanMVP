 ...
 * invoke {@link Presenter#updateModel()} to update this {@link Model} values
 * <p>
 ...
 * {@link Request} : mark the {@link Entity} variables with this annotation so that
...
public abstract class Model implements
    ...
    public void initialize(Observer observer) {
        ...
        new RequestAnnotationScanner().execute(this);
