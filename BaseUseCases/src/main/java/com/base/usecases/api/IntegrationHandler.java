 ...
 * {@link HttpRequestUrlLocator} : the class that locates the production/test base https urls<br>
 * {@link WebSocketUrlLocator} : the class that locates the production/test base wss urls<br>
 * {@link RefreshTokenEntity} : the implementer for {@link AbstractRefreshToken} class<br>
 * <p>
...
public class IntegrationHandler implements AbstractIntegrationHandler {
     ...
     *                       similar annotations
     * @return the related {@link RequestUrlLocator}
     * @throws UnsupportedOperationException if no annotation was found
     */
    public RequestUrlLocator getUrlLocator(Object annotatedClass)
            throws AnnotationNotDeclaredException {
        ...
        if (klass.isAnnotationPresent(HttpRequestUrlLocator.class)) {
            ...
            throw new AnnotationNotDeclaredException(HttpRequestUrlLocator.class);
        }
    }
